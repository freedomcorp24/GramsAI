...
import { encryptedJson, encryptedText } from "../database/encrypted-column"
...
export const MessageTable = sqliteTable(
  "message",
  {
    ...
    ...Timestamps,
    data: encryptedJson<LegacyMessageData>().notNull(),
  },
...
export const PartTable = sqliteTable(
  "part",
  {
    ...
    ...Timestamps,
    data: encryptedJson<LegacyPartData>().notNull(),
  },
  (table) => [
...
export const SessionMessageTable = sqliteTable(
  "session_message",
  {
    ...
    ...Timestamps,
    data: encryptedJson<SessionMessageData>().notNull(),
  },
  (table) => [
