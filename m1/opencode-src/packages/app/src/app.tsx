            ...
            <QueryProvider>
              <ServerSDKProvider>
                <ServerSyncProvider>
                  ...
                  >
                    {/* Clean "/" Home: DirectoryLayout (real, proven init path) resolves
                        to the default /workspace, rendering the new-session composer.
                        Typing branches a fresh worktree and pushes /:dir/session/:id. */}
