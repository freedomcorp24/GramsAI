...
export function SessionSidePanel(props: {
  ...
  browserPanel: () => JSX.Element // GRAMSAI_BROWSER_TAB
                  ...
                  <Tabs value={activeTab()} onChange={openTab}>
                    <div class="sticky top-0 shrink-0 flex">
                      ...
                      >
                        ...
                        {/* GRAMSAI_BROWSER_TAB: always shown when the panel is open */}
                        <Show when={reviewTab()}>
                        ...
                        {/* GRAMSAI_FILES_TAB: full per-chat worktree file tree */}
                        <Show when={reviewTab()}>
                    ...
                    <Show when={reviewTab()}>
                      <Tabs.Content value="browser" class="flex flex-col h-full overflow-hidden contain-strict">
                        <Show when={reviewOpen() && activeTab() === "browser"}>{props.browserPanel()}</Show>
                      </Tabs.Content>
                    </Show>
                    {/* GRAMSAI_FILES_TAB */}
                    <Show when={reviewTab()}>
                      <Tabs.Content value="files" class="flex flex-col h-full overflow-hidden contain-strict">
                        <Show when={reviewOpen() && activeTab() === "files"}>
